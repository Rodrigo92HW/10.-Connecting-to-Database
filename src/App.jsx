...
function App() {
  ...
  const handleRemovePlace = useCallback(async function handleRemovePlace() {
    ...
    try {
      await updateUserPlaces(userPlaces.filter(place.id !== selectedPlace.current.id))
    } catch (error) {
      setUserPlaces(userPlaces);
  ...
  return (
    <>
      <Modal open={errorUpdatingPlaces} onClose={handleError}>
        {errorUpdatingPlaces && (<ErrorPage title="An error ocurred!" message={errorUpdatingPlaces.message} onConfirm={handleError} />)}
      </Modal>
